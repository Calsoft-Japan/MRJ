page 50013 "Closed Purch Order Subform"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
...
#pragma warning restore AA0074
    ...
    procedure CancelClose(PurchHeader: Record "Purchase Header")
    var
        PurchLine: Record "Purchase Line";
        PurchLine2: Record "Purchase Line";
    begin
        PurchLine.Reset();
        PurchLine.SetRange("Document Type", PurchLine."Document Type"::"Closed Order");
        PurchLine.SetRange("Document No.", PurchHeader."No.");
        if PurchLine.FindSet() then
            repeat
                PurchLine2.TransferFields(PurchLine);
                PurchLine2."Document Type" := PurchLine."Document Type"::Order;
                PurchLine2.Insert();
